...
df_init = pd.read_csv("src/producers/insee/assets/v_region_2024.csv", encoding="UTF-8", na_values="")
...
try:
    ...
    df.to_parquet("src/params/insee/table_reg.parquet", engine="pyarrow", compression="gzip")
