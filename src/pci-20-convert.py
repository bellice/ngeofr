...
# Chemin dossier
path_input = Path("G:/ign/parcellaire-express/unzip")
path_output = Path("G:/ign/parcellaire-express/parquet")
...
for file in files_filtered:
    ...
    start_time = time.time()
    df.to_parquet(
        path = path_output / f"{date}-pci-parcelle-{code_dep}.parquet",
        compression = "gzip")
