...
datecom_init <- read.csv(here("src/assets/insee/2023/cog_ensemble_2023_csv/v_commune_depuis_1943.csv"),
                         encoding = "UTF-8", na.strings = "")


# Communes nouvelles
com_nouvelle_init <- read_excel(here("src/assets/insee/2023/Communes_nouvelles_2022.xlsx"))

# Liste événement sur les epci à fiscalité propre
mvtepci_init <- read.csv(here("src/script/ngeo-cog/table-evenement-epci.csv"),
                                       encoding = "UTF-8")
